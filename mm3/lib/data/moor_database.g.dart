...
class $MedicationsTable extends Medications
  ...
  Medication map(Map<String, dynamic> data, {String? tablePrefix}) {
    return Medication.fromData(data, _db,
...
class ChartEvent extends DataClass implements Insertable<ChartEvent> {
  ...
  ChartEvent(
      ...
      this.event_dtm});
  factory ChartEvent.fromData(Map<String, dynamic> data, GeneratedDatabase db,
      {String? prefix}) {
    final effectivePrefix = prefix ?? '';
    return ChartEvent(
      id: const StringType()
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || event_dtm != null) {
  ...
  @override
  int get hashCode => Object.hash(
      id, medication_id, event_description, event_short_desc, event_dtm);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ChartEvent &&
...
class $ChartEventsTable extends ChartEvents
  ...
  ChartEvent map(Map<String, dynamic> data, {String? tablePrefix}) {
    return ChartEvent.fromData(data, _db,
        prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
class $NdcProductsTable extends NdcProducts
  ...
  NdcProduct map(Map<String, dynamic> data, {String? tablePrefix}) {
    return NdcProduct.fromData(data, _db,
        prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
